...
First of all, it should be noted that all of the raw data does not live in this repository! Instead it can be found here: https://figshare.com/s/18c60e6ae46f702d1912
In order for all the preprocessing files to run properly, the corresponding folders with the raw data need to be downloaded from figshare and placed in the right directory (i.e., the folders with the CVA prefix belong into the CVA folder).
